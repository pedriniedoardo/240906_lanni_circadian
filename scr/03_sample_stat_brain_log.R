...
df_lm %>%
  write_csv("../../out/table/03_df_lm_additive_brain_log.csv")  
...
df_lm_lanni %>%
  write_csv("../../out/table/03_df_lm_additive_brain_lanni_log.csv")  
...
ggsave("../../out/plot/03_sample_stat_brain_log.pdf",width = 21,height = 10)
...
df_full_lanni %>%
  ...
  theme(strip.background = element_blank()) +
  scale_color_viridis(option = "turbo")
ggsave("../../out/plot/03_sample_stat_brain_lanni_log.pdf",width = 21,height = 10)
